...
public class Console
{
    ...
    public static void Init()
    {
        ...
        var consoleUI = GameObject.Instantiate(Resources.Load<ConsoleGUI>("Prefabs/ConsoleGUI"));
        GameObject.DontDestroyOnLoad(consoleUI);
    ...
    public static void ExecuteCommand(string command)
    {
        ...
        else if (ConfigVar.ConfigVars.TryGetValue(commandName, out configVar))
        {
            ...
            {
                // Print value
                OutputString(string.Format("{0} = {1},{2}", configVar.name, configVar.Value,configVar.description));
            }
            else
            {
