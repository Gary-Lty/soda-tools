...
namespace OscCore
{
    ...
    class PropertyOutputInspector : Editor
    {
        ...
        SerializedProperty m_MemberIsProperty;
        ...
        void OnEnable()
        {
            ...
            m_MemberIsProperty = serializedObject.FindProperty("m_MemberIsProperty");
        ...
        void PropertyDropdown()
        {
            ...
            if (newIndex != m_PropertyIndex)
            {
                ...
                if (asProp != null)
                {
                    ...
                    m_MemberIsProperty.boolValue = true;
                }
                else
                {
                    var asField = info as FieldInfo;
                    m_Target.Field = asField;
                    m_MemberIsProperty.boolValue = false;
